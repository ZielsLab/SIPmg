...
#f_tibble = read_csv(file="f_tibble.csv")
...
gtdbtk_archaea = read_delim("gtdbtk.ar122.summary.tsv", 
                             "\t", escape_double = FALSE, trim_ws = TRUE)
#GC content
GC_content <- read_csv(file = "G_content.csv")

#Fractions
fractions_ps = read_csv("fractions.csv")
...
bin_tibble = read_delim("checkm_coverage.tsv", "\t", escape_double = FALSE, trim_ws = TRUE)
#Operator
operator = "mean"
```
