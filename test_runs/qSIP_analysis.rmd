...
#Threshold. Acceptable coefficient of variation for coverage and detection (eg. 20 - for 20 % threshold of coefficient of variation) (Coverages above the threshold value will be flagged in the plots)
threshold = 20
...
mag_tab_scaled <- scale_features_ps(f_tibble, sequins, seq_dil, log_scale, threshold)
