...
## Load data
#Coverage metadata
f_tibble = read_csv(file="mock_import/coverage_metadata.csv")

#Sequins metadata
sequins <- read_csv(file="mock_import/sequins_metadata.csv")

#Dilutions data
seq_dil = read_csv(file = "mock_import/dilutions_data.csv")
...
#Taxonomy
gtdbtk_bac_summary = read_delim("mock_import/gtdbtk.bac120.summary.tsv", 
                                 "\t", escape_double = FALSE, trim_ws = TRUE)
gtdbtk_archaea = read_delim("mock_import/gtdbtk_archaea.tsv", 
                             "\t", escape_double = FALSE, trim_ws = TRUE)
#GC content
GC_content <- read_delim("mock_import/GC_content.tsv", 
    "\t", escape_double = FALSE, trim_ws = TRUE)

#Fractions
fractions_ps = read_csv("mock_import/fractions_ps.csv")
```
